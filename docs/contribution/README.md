...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/summoningpixels/ProxmoxVE → Fork (top right)
...
git remote add upstream https://github.com/summoningpixels/ProxmoxVE.git
...
- **GitHub**: [community-scripts/ProxmoxVE](https://github.com/summoningpixels/ProxmoxVE)
- **Issues**: [GitHub Issues](https://github.com/summoningpixels/ProxmoxVE/issues)
- **Discussions**: [GitHub Discussions](https://github.com/summoningpixels/ProxmoxVE/discussions)
