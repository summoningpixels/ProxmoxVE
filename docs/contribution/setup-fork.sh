...
# upstream   https://github.com/summoningpixels/ProxmoxVE.git (fetch)
# upstream   https://github.com/summoningpixels/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/summoningpixels/ProxmoxVE"
echo ""
